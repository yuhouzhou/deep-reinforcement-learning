...
In this project, an agent is trained by Deep Q Network (DQN) to navigate the environment and collect bananas.
...
With the selected hyper-parameters, the environment was solved in 182 episodes.
